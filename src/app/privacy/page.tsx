...
const SECTIONS: { h: string; p: string[] }[] = [
  ...
  },
  {
    h: "3. Blockchain data",
    p: [
      "Wallet addresses, token balances, and transactions on the Base network are public, permanent, and outside our control. We read this public data to display market information and to compute reward distributions (including periodic snapshots of token balances) as described in our Terms.",
  ...
  },
  {
    ...
    p: [
      "The site links to and relies on third-party services, including our hosting provider (Vercel), the token launch platform (BasedBid), decentralized exchanges (Uniswap), and block explorers (Basescan). Each operates under its own privacy policy; we encourage you to review them. We are not responsible for their practices.",
    ],
  },
  {
